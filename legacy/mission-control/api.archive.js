...
export const api = {
  ...
  v6Packages() {
    return request("/v6/packages", { method: "GET" });
  },
  v6Package(id) {
    return request(`/v6/packages/${encodeURIComponent(id)}`, { method: "GET" });
  },
  createV6Package(input) {
    return request("/v6/packages", {
      method: "POST",
      body: JSON.stringify(input),
    });
  },
  v6PackageDownloadUrl(id) {
    return `${API_BASE}/v6/packages/${encodeURIComponent(id)}/download`;
  },
  v7Projects() {
  ...
  founderTestingProject(id) {
    return request(`/v7/founder-testing/${encodeURIComponent(id)}`, { method: "GET" });
  },
