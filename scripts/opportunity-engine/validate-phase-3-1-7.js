...
const BLOCKED_FUTURE_PHASE_ID = "4.3";
const BLOCKED_FUTURE_PHASE_HEADING = "## Phase 4.3+ (Blocked / Not Started)";
const errors = [];
...
await finalizeValidator({ phase: "3.1.7", errors, startedAt: __validationStartedAt });
