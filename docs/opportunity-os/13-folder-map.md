...
| Path | Purpose | Owner | Future direction |
|---|---|---|---|
| **`scripts/opportunity-engine/`** | CLI reports, validation, manual ingest | OS team | `validate-phase-3-1.js`, `validate-core.js`, `runtime-health.js`, `ingest-signal.js`, `validate-engineering-director.js`, `validate-business-operators.js`, `validate-phase-4-2.js` |
